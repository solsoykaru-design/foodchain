...
const PROMPT_TEMPLATE = `Ты — профессиональный технолог общественного питания. Составь технологическую карту для блюда «{name}». Категория блюда: {category}. Используй классические ингредиенты и их граммовку (нетто на 1 порцию).
...
async function generateTechCard(dishName) {
  ...
  return await Promise.race([
    ...
    new Promise(resolve => setTimeout(() => resolve(queryLocalDB(dishName)), 85000)),
  ]);
}
