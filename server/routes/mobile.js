...
3. "pay" — оплатить. Примеры: "оплата заказа 128", "оплати заказ 128", "расчёт по заказу 128"
4. "close" — закрыть. Примеры: "закрыть заказ 128", "закрой заказ 128"
5. "cancel" — отменить. Примеры: "отмена заказа", "отмени заказ", "удали черновик"
6. "refund" — возврат. Примеры: "возврат по заказу 128", "верни заказ 128"
...
Верни ТОЛЬКО JSON:
{
  ...
  "command_params": { "order_number": число или null },
